...
%
%   Attention!
%   this function overloads WAVREAD, but returns single-precision values
...
[~,~,ext] = fileparts(file);        % [path, name, extention] = fileparts()
if isempty(ext),
  file = [file 'running_outside_20ms.wav'];
end
...
dat.Data   = single(fread(datack.fid, [wavefmt.nChannels nSPCext], dtype));
%
% Update count of bytes remaining:
