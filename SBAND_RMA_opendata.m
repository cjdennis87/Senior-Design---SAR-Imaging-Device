...
[Y,FS] = audioread(['outside_final3am_1708_timed.wav']);
...
%Rs = 2*(12+9/12)*.3048; %(m) y coordinate to scene center (down range), make this value equal to distance to cal target
Rs = 0;
